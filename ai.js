...
function mockQuestions({ topic, count }) {
  const bank = [
    ...
    { question: `A friend asks you about ${topic}. What's the safest first answer?`, options: ['"Let me look that up."', '"It\\'s overrated."', '"I invented it."', '"It doesn\\'t exist."'], correctIndex: 0 },
